...
var aiCapabilities = []AICapability{
	...
	{Purpose: "release.engineering", Action: "release.plan", DefaultAutonomy: AIAutonomyApprovalRequired, Risk: AIRiskHigh, ActionClass: AIActionProposal, RequiredFeature: "ai.release", RequiredRoles: []string{"settings.read"}, AuditEvents: []string{"ai.release.plan.created"}},
	{Purpose: "incident.response", Action: "incident.plan", DefaultAutonomy: AIAutonomyApprovalRequired, Risk: AIRiskHigh, ActionClass: AIActionProposal, RequiredFeature: "ai.incident", RequiredRoles: []string{"environments.read"}, AuditEvents: []string{"ai.incident.plan.created"}},
	{Purpose: "security.compliance", Action: "security.plan", DefaultAutonomy: AIAutonomyApprovalRequired, Risk: AIRiskHigh, ActionClass: AIActionProposal, RequiredFeature: "ai.security", RequiredRoles: []string{"environments.read"}, AuditEvents: []string{"ai.security.plan.created"}},
