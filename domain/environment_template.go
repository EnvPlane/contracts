...
type DependencyPolicy struct { Name string `json:"name"`; Mode string `json:"mode"`; Namespace string `json:"namespace,omitempty"`; Target string `json:"target,omitempty"` }
...
type EnvironmentTemplateRevision struct {
	...
	SourceNamespaces []string `json:"sourceNamespaces"`; ObservedVersions map[string]string `json:"observedVersions,omitempty"`; Resources []ResourceTemplate `json:"resources"`; Dependencies []DependencyPolicy `json:"dependencies,omitempty"`; Parameters []TemplateParameter `json:"parameters,omitempty"`; Digest string `json:"digest"`; CreatedAt time.Time `json:"createdAt"`; PublishedAt time.Time `json:"publishedAt"`
}
